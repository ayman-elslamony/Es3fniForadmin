                      ...
                      children: <Widget>[
                         ...
                         Padding(
                           ...
                           child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              labelText: translator.currentLanguage == "en" ?'Email':'البريد الالكترونى',
                            ...
                            validator: (val) {
                              if (val.isEmpty || !val.contains('@')) {
                                return translator.currentLanguage == "en" ?'InvalidEmail':'البريد الالكترونى غير صحيح';
                              }
                            },
                            onSaved: (val) {
                              email = val;
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            validator: (val) {
                              if (val.trim().isEmpty) {
                                return translator.currentLanguage == "en" ?'Invalid password':'كلمه المرور غير صحيحه';
                              }
                              if ( val.trim().length < 4) {
                                return translator.currentLanguage == "en" ?'Short password':'كلمه المرور ضعيفه';
                              }
                            },
                            onSaved: (val) {
                              password = val;

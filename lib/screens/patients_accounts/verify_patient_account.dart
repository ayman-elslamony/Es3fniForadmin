        ...
        return Directionality(
          ...
          child: Scaffold(
            ...
            HawkFabMenu(
              ...
              items: [
                HawkFabMenuItem(
                    label: translator.currentLanguage == "en" ? 'Accept Acount' : 'قبول الحساب',
                    ontap:() async{
                ...
                HawkFabMenuItem(
                    label: translator.currentLanguage == "en" ? 'Delete Account' : 'حذف الحساب',
                    ontap:() async{
                      ...
                      children: <Widget>[
                        ...
                        widget.userData.name==''?SizedBox():personalInfo(
                            title: translator.currentLanguage == "en"
                                ...
                                : 'الاسم',
                            subtitle:
                                translator.currentLanguage == "en" ? widget.userData.name : widget.userData.name,
                        ...
                        widget.userData.imgId != ''?ListTile(
                          onTap: (){
                            Navigator.of(context).push(MaterialPageRoute(builder: (context)=>ShowImage(
                              title: translator.currentLanguage == "en" ? 'Picture for national id'
                                  : 'صوره البطاقه',
                          ...
                          title: Text(
                            translator.currentLanguage == "en" ? 'Picture for national id'
                            : 'صوره البطاقه',
                            style:
                  ...
                  infoWidget: infoWidget),
                        widget.userData.gender==''?SizedBox(): personalInfo(
                            title: translator.currentLanguage == "en"
                                ...
                                : 'النوع',
                            subtitle:
                                translator.currentLanguage == "en" ? widget.userData.gender : widget.userData.gender,
                        ...
                        widget.userData.aboutYou==''?SizedBox(): personalInfo(
                            title: translator.currentLanguage == "en"
                                ...
                                : 'معولمات اخرى',
                            subtitle:
                            translator.currentLanguage == "en" ? widget.userData.aboutYou : widget.userData.aboutYou,
                            iconData: Icons.view_agenda,
                            infoWidget: infoWidget),
                        widget.userData.points==''?SizedBox():personalInfo(
                            title: translator.currentLanguage == "en"
                                ...
                                : 'النقاط',
                            subtitle:
                                translator.currentLanguage == "en" ? widget.userData.points : widget.userData.points,

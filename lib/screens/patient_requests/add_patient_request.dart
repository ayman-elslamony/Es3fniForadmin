...
import 'package:es3fniforadmin/screens/shared_widget/flutter_time_picker_spinner.dart';
...
class _AddPatientRequestState extends State<AddPatientRequest> {
  ...
  List<String> _selectedWorkingDays = <String>[];
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      msg: translator.activeLanguageCode == "en" ? "Scuessfully Discount" : 'نجح الخصم',  );
                                                                                  ...
                                                                                  flutterToast(
                                      msg: translator.activeLanguageCode == "en" ? 'add service before discount' : 'اضف الخدمه قبل الخصم',  );
                                                                                }else if (x == 'isUserBefore') {
                                                                                  flutterToast(
                                      msg: translator.activeLanguageCode == "en" ? 'this coupon is used before' : 'تم استخدام الكوبون من قبل',  );
                                                                                }else if (x == 'add Phone') {
                                                                                  flutterToast(
                                      msg: translator.activeLanguageCode == "en" ? 'add patient phone number before use coupon' : 'اضف رقم الهاتف الخاص بالمريض قبل استخدام الكوبون',  );
                                                                                } else if (x == 'Coupon not Avilable') {
                                                                                  flutterToast(
                                      msg: translator.activeLanguageCode == "en" ? 'Coupon not Avilable' : 'الكود غير متاح',  );
                                                                                } else if (x == 'false') {
                                                                                  flutterToast(
                                      msg: translator.activeLanguageCode == "en" ? "Invalid Coupon" : 'الكوبون غير متاح',  );
                                                                                } else {
                                                                                  flutterToast(
                                      msg: translator.activeLanguageCode == "en" ? "Already Discount" : 'تم الخصم بالفعل',  );
                                                                                }
                                                                                setState(() {

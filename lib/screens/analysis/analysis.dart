...
class _AnalysissState extends State<Analysiss> {
  ...
  Widget content({required Analysis analysis, required DeviceInfo infoWidget}) {
    return Padding(
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Column(
                children: <Widget>[
                  analysis.loading ?Center(child: const CircularProgressIndicator(color:  Colors.indigo,)):RaisedButton(
                    onPressed: () async{
                     setState(() {

          ...
          GoogleMap(
            ...
            onTap: (pos) async{
              ...
              showDialog(
                ...
                title: Text(
                  translator.activeLanguageCode == "en" ?'Are you sure':'هل انت متأكد',
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          child: Container(height: 60 ,width: MediaQuery.of(context).size.width/0.85,child: TextFormField(
                            ...
                            labelText: translator.activeLanguageCode == "en" ?'this is Your location':'ان هذا موقعك',
                ...
                actions: <Widget>[
                  FlatButton(
                    child: Text(translator.activeLanguageCode == "en" ?'Cancel':'الغاء'),
                    onPressed: () {
                      Navigator.of(ctx).pop();
                    },
                  ),
                  FlatButton(
                    child: Text(translator.activeLanguageCode == "en" ?'ok':'موافق'),
                    onPressed: () {
                    ...
                    Expanded(
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                            ...
                            labelText: translator.activeLanguageCode == "en" ?'Search for Location':'ابحث عن موقع',
                            focusedBorder: OutlineInputBorder(
                              borderRadius: BorderRadius.all(Radius.circular(10.0)),
                              borderSide: BorderSide(
                                color: Colors.indigo,
